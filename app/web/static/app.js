...
async function renderHere() {
  ...
  main.replaceChildren(pageHead("HERE / NOW", `Welcome, ${state.user.display_name}.`, "See present reality clearly, then move one meaningful thing forward."), node("div", { class: "grid" },
    ...
    node("section", { class: "card span-4 interactive", tabindex: "0", onClick: () => navigate("log"), onKeydown: (e) => { if (e.key === "Enter") navigate("log"); } }, node("p", { class: "eyebrow" }, "PRIVATE"), node("h3", {}, "Captain’s Log"), node("p", { class: "muted" }, "Record what is true before deciding what comes next.")),
    node("section", { class: "card span-4 interactive", tabindex: "0", onClick: () => navigate("guide"), onKeydown: (e) => { if (e.key === "Enter") navigate("guide"); } }, node("p", { class: "eyebrow" }, "REFLECTION"), node("h3", {}, "LANSEIR Guide"), node("p", { class: "muted" }, "Use authorized context without exposing your private journal by default.")),
